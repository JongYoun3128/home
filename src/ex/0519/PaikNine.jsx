    ...
    return (
        <div className="one wrap">
            ...
            <div className="title_box">                
                <h2 className="big_title text-3xl">한우생돌곱창구이</h2>
                <p>전라도 12첩 반상과 즐기는 소곱창!</p>
            </div>
            ...
            <ul className="map_box">
                <li className="map_menu icon_img">
                    ...
                    <p>전남 장성군 장성읍</p>
                    <button onClick={()=>navigate('/paikmap_9')}>지도보기</button>
                </li>
            ...
            <iframe width="100%" height="400" src="https://www.youtube.com/embed/FpnRPY9Rfdo?si=EqqyczGPATAMgWmz" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
